...
feather::write_feather(
  ...
  path = "data/meta/lhf_paleo_meta_05_2024.feather"
)
```

```{r pairs_panel}
# quick plot of correlations
psych::pairs.panels(
  x = paleo_env_mean_formatted
)
...
feather::write_feather(
  x = lhf_wcvp_summary_tb, 
  path = "data/meta/lhf_wcvp_summary_05_2024.feather"
)
```
...
feather::write_feather(
  x = outbreaks, 
  path = "data/meta/lhf_outbreaks_05_2024.feather"
)
```
